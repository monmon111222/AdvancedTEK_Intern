...
<!--===============================================================================================-->
	...
	function getlabel(){
		...
		$.ajax({
			...
			success: function(result){
				...
				arr+=result[0].Product_Name;
				for(var i=1;i<result.length;i++){
					arr+=","+result[i].Product_Name+' 款式 '+result[i].ProductStyle_Vaule;
				}
	...
	function prd_chart(){
	       $('body').css('background', '-webkit-linear-gradient(#556270,#2196f3)');
		...
		var doID ="${doID}"	
			...
			function submit_table(result,dolevel){
				...
				tableData+="<tr>"
					...
					tableData+="<td>"+obj[i].Product_Name+' 款式 '+obj[i].ProductStyle_Vaule+"</td>"
...
<body >
	<jsp:include page="../slidemenu.jsp"/>
		<div class="wrap-login100">
					<span class="login100-form-title" style="font-family: HanyiSentyGarden;font-size: 70px;">
						商品銷售報表
					</span>
