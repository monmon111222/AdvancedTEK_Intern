 ...
 */
@WebServlet("/GetCategoryServelt")
public class GetCategoryServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("GetCategoryServelt");
		...
		String sql="SELECT`"+colname1+"`,`"+colname2+"` FROM `"+tablename+"` WHERE `"+tablename+"_SellerID`="+doID;
		try {
