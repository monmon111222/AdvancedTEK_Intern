 ...
 */
@WebServlet("/CSVUploadServlet2")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 10, // 10MB
        maxRequestSize = 1024 * 1024 * 50) // 50MB
public class CSVUploadServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        while((line=reader.readLine())!=null){
           ...
           try {
        	   insert_pstmt = con
   					.prepareStatement("INSERT INTO `Product` (`Product_Price`, `Product_Name`, `Product_Detail`,`Product_InsDate`,`Product_Quanity`, `Product_Vaild`,`Product_SellerID`, `Product_ID`) VALUES (?,?,?,?,?,?,?,?)");
...
//		System.out.println(category);
        ...
        try {
        	...
        	insert_pstmt.setInt(1,Integer.parseInt(pid)); 
